      ...
      <div className="min-h-screen bg-gray-50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900">Loyalty Records</h1>
            <div data-testid="customer-loyalty-record-list-loading">Loading…</div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900">Loyalty Records</h1>
            <div
              data-testid="customer-loyalty-record-list-error"
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6 space-y-4">
          ...
          <div data-testid="customer-loyalty-record-list">
            {!items || items.length === 0 ? (
              <div data-testid="customer-loyalty-record-list-empty" className="text-gray-500 text-sm">
                No loyalty records.
              </div>
            ) : (
              <ul className="divide-y divide-gray-100">
                {items.map((s) => (
                  <li key={s.id} data-testid={`customer-loyalty-record-item-${s.id}`} className="py-3">
                    <Link
