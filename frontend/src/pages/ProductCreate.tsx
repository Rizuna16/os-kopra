        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6">
          ...
          <form data-testid="product-create-form" onSubmit={handleSubmit}>
            <div>
              ...
              />
              {fieldError && <div data-testid="product-create-error" className="text-sm text-red-600 bg-red-50 border border-red-100 rounded-xl p-3 sm:p-4">{fieldError}</div>}
              {serverError && <div data-testid="product-create-error" className="text-sm text-red-600 bg-red-50 border border-red-100 rounded-xl p-3 sm:p-4">{serverError}</div>}
            </div>
            <div>
