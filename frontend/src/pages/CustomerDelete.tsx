    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6">
          <div data-testid="customer-delete" className="space-y-3">
            <button
              type="button"
            ...
            {deleting && <span data-testid="customer-delete-deleting" className="text-gray-500">Deleting…</span>}
            {error && <div data-testid="customer-delete-error" className="text-sm text-red-600 bg-red-50 border border-red-100 rounded-xl p-3 sm:p-4">{error}</div>}
          </div>
        </div>
      </div>
    </div>
